...
@implementation ICNLocalVideoView {
    ECStream *_stream;
    UILabel  *_nameText;
}
...
- (instancetype)initWithStream:(ECStream *)stream
    ...
    if(self) {
        ...
        _nameText.text = stream.getAttributes[@"actualName"];
...
- (void)layoutSubviews {
    _nameText.mh_width = self.bounds.size.width - 10;
...
# pragma mark - ICNConferenceVideo implement
- (UIView *)getView {
    return self;
}
...
- (BOOL)enableVideo{
    return _stream.mediaStream.videoTracks[0].isEnabled;
}
